...
class Xero {
    ...
    public function __call($name, $arguments) {
        ...
        if ((count($arguments) == 0) || ( is_string($arguments[0]) ) || ( is_numeric($arguments[0]) ) || ( $arguments[0] === false )) {
            ...
            $strAgent = "Mozilla/5.0 (X11; U; Linux x86_64; en-US; rv:1.9.0.19) Gecko/2010040121 Ubuntu/9.04 (jaunty) Firefox/3.0.19";
            $ch = curl_init();
            ...
            if (in_array($name, $valid_post_methods)) {
                ...
                curl_setopt($ch, CURLOPT_HTTPHEADER, $req->to_header());
            } else {
                $xero_url = self::ENDPOINT . $method;
...
class OAuthRequest {
    ...
    public static function from_request($http_method=NULL, $http_url=NULL, $parameters=NULL) {
        ...
        colsole.log('error','Parameters'. $parameters);
        if (!$parameters) {
